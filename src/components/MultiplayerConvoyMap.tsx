...
export default function MultiplayerConvoyMap({
  ...
  const defaultLng = currentMember?.longitude ?? checkpoint?.longitude ?? 106.9942;
      ...
      const riderIcon = L.divIcon({
        ...
        html: `
          <div class="relative flex items-center justify-center">
            ...
            } border-2 border-white rounded-2xl flex items-center justify-center shadow-2xl text-white font-black text-xs overflow-hidden">
              ${
                member.avatar_url
    ...
    <div className="relative w-full h-full min-h-[500px] lg:min-h-[660px] bg-slate-900 rounded-3xl overflow-hidden border border-slate-800 shadow-2xl">
      ...
      <div className="absolute top-4 right-4 z-[500] flex flex-col gap-2">
        ...
        <button
          ...
          title="Lihat Seluruh Anggota Konvoi"
        ...
        >
          ...
          <span>Lihat Konvoi ({members.length})</span>
        </button>
      </div>
